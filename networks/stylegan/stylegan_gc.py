...
class StyleGANGeneratorConstructor:
    ...
    def _construct_generator(self):
        # 1. Set precision policy (float16 / float32).
    ...
    def _compile_model(self, model):
        ...
        model.compile(optimizer=Adam(learning_rate=lr, beta_1=beta_1, beta_2=beta_2, epsilon=epsilon))
    ...
    def _broadcast_disentangled_latents(self, x):
        return tile(x[:, np.newaxis], [1, self.n_styles, 1])
