...
from gans.loss import discriminator_loss
...
class StyleGANDiscriminator(Model):
    ...
    def train_on_batch(self, image_processor, generator, batch_size, shape, image_augmenter):
        ...
        x_real = image_augmenter.transform_tensors(x_real, is_tensor=False)
        ...
        x_fake = image_augmenter.transform_tensors(x_fake, is_tensor=False)
